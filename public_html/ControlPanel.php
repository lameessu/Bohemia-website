...
<html>
<head>
<title>Bohemia Hotels - Control Panel</title>
...
<div id = "centerForm">
<fieldset id="fieldset"><legend>Controls</legend>
<form action= "addpage.php">
    <input class= "controls" type="submit" tabindex = "1" value="Add a Hotel page">
</form>

<form  action= "editpage.php">
    <input class= "controls"  type="submit" tabindex = "2" value="Edit a Hotel page">
</form>

<form  action= "deletepage.php">
    <input class= "controls" type="submit" tabindex = "3" value="Delete a Hotel page">
</form>
</fieldset>
<br/>
</div>
